...
#### In this chapter we will import a construct library called cdk-dynamo-table-viewer into our project and install it on our hit counter table
...
2. Add a table viewer to your stack in lib/cdk-workshop-stack.ts
```js
...
3. Add a table property to our hit counter
